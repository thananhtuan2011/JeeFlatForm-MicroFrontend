...
@Component({
  selector: 'app-list-users-custom',
  templateUrl: './list-users-custom.component.html',
  styleUrls: ['./list-users-custom.component.scss']
})
export class ListUsersCustomComponent implements OnInit {
  @Input() item :any = [];
