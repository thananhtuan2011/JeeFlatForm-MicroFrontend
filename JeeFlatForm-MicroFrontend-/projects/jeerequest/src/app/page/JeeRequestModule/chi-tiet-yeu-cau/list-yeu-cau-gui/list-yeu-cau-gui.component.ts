...
@Component({
  selector: 'app-list-yeu-cau-gui',
  templateUrl: './list-yeu-cau-gui.component.html',
  styleUrls: ['./list-yeu-cau-gui.component.scss']
})
export class ListYeuCauGuiComponent implements OnInit {
  @Input() keyword?: any;
  @Input() tuNgay?: any;
  @Input() denNgay?: any;
  ...
  ngOnInit() {
    this.loadDataList()
    this.requestsService.data_shareGui$.subscribe((data: any) => {
