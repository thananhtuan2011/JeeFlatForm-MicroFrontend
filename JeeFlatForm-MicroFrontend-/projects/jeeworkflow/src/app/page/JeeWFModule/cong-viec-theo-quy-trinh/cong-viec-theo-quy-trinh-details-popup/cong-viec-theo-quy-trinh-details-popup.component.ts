...
@Component({
    selector: 'app-cong-viec-theo-quy-trinh-details-popup',
    templateUrl: './cong-viec-theo-quy-trinh-details-popup.component.html',
})
export class CongViecTheoQuyTrinhDetailsPopupComponent implements OnInit {
    ...
    constructor(public dialogRef: MatDialogRef<CongViecTheoQuyTrinhDetailsPopupComponent>,
    ...
    ngOnInit(): void {
        ...
        this.TypeID = +this.data._item._typeid;
        this.StageID = +this.data._item._stageid;
        this.TaskID = +this.data._item._taskid;
        if (this.TypeID == 1) {
            this.itemCV = [];
            this.CheckJeeWork();
    ...
    getWidthDetailsLeft(): any {
        let tmp = 0
        tmp = document.getElementById("body-details").clientWidth - 400;
        return tmp + "px";
    }
