...
import { CongViecTheoQuyTrinhDetailsPopupComponent } from './cong-viec-theo-quy-trinh-details-popup/cong-viec-theo-quy-trinh-details-popup.component';
...
import { ListDepartmentService } from '../../services/jee-work.service';
...
@NgModule({
  declarations: [
    CongViecTheoQuyTrinhDetailsPopupComponent,
  ],
  imports: [
    CommonModule,
    MatInputModule,
...
export class CongViecTheoQuyTrinhRefModule {}
