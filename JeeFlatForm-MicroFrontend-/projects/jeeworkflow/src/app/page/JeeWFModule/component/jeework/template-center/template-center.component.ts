...
import { ListDepartmentService, ProjectsTeamService } from "../../../../services/jee-work.service";
import { QueryParamsModelNew } from "../../../../models/query-models/query-params.model";
import { DepartmentModel, FileUploadModel, ProjectTeamModel } from "../../../../models/jee-work.model";
@Component({
...
export class TemplateCenterComponent implements OnInit {
  ...
  selectedParent(item) {
    this.ItemParentID.RowID = item.RowID;
  ...
  IsChecked(item) {
    if (
      item.RowID == this.ItemParentID.RowID &&
    ...
    if (this.TemplateDetail.types > 1) {
      if (this.ItemParentID.type > 0) {
        if (this.ItemParentID.type >= this.TemplateDetail.types) {
          ...
          ww_duan.ParentID = this.ItemParentID.RowID > 0 ? this.ItemParentID.RowID : 0;
        }
      } else {
