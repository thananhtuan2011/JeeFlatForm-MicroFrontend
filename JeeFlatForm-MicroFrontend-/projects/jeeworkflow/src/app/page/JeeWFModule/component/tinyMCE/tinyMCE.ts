...
const tinyMCE = {
	...
	images_upload_url: environment.HOST_JEEWORKFLOW_API + '/Tool/upload-img?filename=' + 'GuideLine',
	...
	images_upload_handler: function (blobInfo, success, failure) {
		...
		xhr.open('POST', environment.HOST_JEEWORKFLOW_API + '/Tool/upload-img?filename=' + 'GuideLine');
