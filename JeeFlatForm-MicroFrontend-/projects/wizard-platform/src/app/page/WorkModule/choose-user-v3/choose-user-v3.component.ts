...
@Component({
  selector: 'kt-choose-user-v3',
  templateUrl: './choose-user-v3.component.html',
  styleUrls: ['./choose-user-v3.component.scss']
})
export class ChooseUsersV3Component implements OnInit {
