...
import { DanhMucChucVuListComponent } from "./danh-muc-chuc-vu-list/danh-muc-chuc-vu-list.component";
...
const routes: Routes = [
  {
    path: '',
    component: DanhMucChucVuComponent,
    children: [
      {
        path: '',
        component: DanhMucChucVuListComponent,
      },
    ]
  }
];
...
@NgModule({
  declarations: [
    ...
    DanhMucChucVuListComponent,
    DanhMucChucVuEditDialogComponent,
  ],
  imports: [
