...
import { HinhThucChamCongListComponent } from "./hinh-thuc-cham-cong-list/hinh-thuc-cham-cong-list.component";
...
import { HinhThucChamCongComponent } from "./hinh-thuc-cham-cong.component";
...
const routes: Routes = [
  {
    path: '',
    component: HinhThucChamCongComponent,
    children: [
      {
        path: '',
        component: HinhThucChamCongListComponent,
      },
    ]
  }
];
...
@NgModule({
  declarations: [
    HinhThucChamCongComponent,
    HinhThucChamCongListComponent,
  ],
  imports: [
  ...
  providers: [
    ...
    HinhThucChamCongService,
    HttpUtilsService,
    LayoutUtilsService,
    TranslationService,
  ],
})
export class HinhThucChamCongModule { }
