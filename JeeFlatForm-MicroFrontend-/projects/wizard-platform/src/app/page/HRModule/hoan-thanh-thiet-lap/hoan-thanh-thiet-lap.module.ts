...
import { HoanhThanhThietLapListComponent } from "./hoan-thanh-thiet-lap-list/hoan-thanh-thiet-lap-list.component";
...
import { HoanhThanhThietLapComponent } from "./hoan-thanh-thiet-lap.component";
...
const routes: Routes = [
  {
    path: '',
    component: HoanhThanhThietLapComponent,
    children: [
      {
        path: '',
        component: HoanhThanhThietLapListComponent,
      },
    ]
  }
];
...
@NgModule({
  declarations: [
    HoanhThanhThietLapComponent,
    HoanhThanhThietLapListComponent,
  ],
  imports: [
  ...
  providers: [
    ...
    HoanhThanhThietLapService,
    HttpUtilsService,
    LayoutUtilsService,
    TranslationService,
  ],
})
export class HoanhThanhThietLapModule { }
