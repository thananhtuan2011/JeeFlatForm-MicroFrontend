...
import { DanhMucNhanVienListComponent } from "./danh-muc-nhan-vien-list/danh-muc-nhan-vien-list.component";
...
import { DanhMucNhanVienComponent } from "./danh-muc-nhan-vien.component";
...
const routes: Routes = [
  {
    path: '',
    component: DanhMucNhanVienComponent,
    children: [
      {
        path: '',
        component: DanhMucNhanVienListComponent,
      },
    ]
  }
];
...
@NgModule({
  ...
  providers: [
    ...
    DanhMucNhanVienService,
    HttpUtilsService,
    LayoutUtilsService,
    TranslationService,
  ],
})
export class DanhMucNhanVienModule { }
