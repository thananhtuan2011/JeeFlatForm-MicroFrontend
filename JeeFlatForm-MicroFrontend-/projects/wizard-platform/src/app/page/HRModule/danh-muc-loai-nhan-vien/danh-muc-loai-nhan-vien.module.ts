...
import { DanhMucLoaiNhanVienListComponent } from "./danh-muc-loai-nhan-vien-list/danh-muc-loai-nhan-vien-list.component";
...
import { DanhMucLoaiNhanVienComponent } from "./danh-muc-loai-nhan-vien.component";
...
const routes: Routes = [
  {
    path: '',
    component: DanhMucLoaiNhanVienComponent,
    children: [
      {
        path: '',
        component: DanhMucLoaiNhanVienListComponent,
      },
    ]
  }
];
...
@NgModule({
  declarations: [
    DanhMucLoaiNhanVienComponent,
    DanhMucLoaiNhanVienListComponent,
    DanhMucLoaiNhanVienEditDialogComponent,
  ],
  imports: [
  ...
  providers: [
    ...
    DanhMucLoaiNhanVienService,
    HttpUtilsService,
    LayoutUtilsService,
    TranslationService,
  ],
})
export class DanhMucLoaiNhanVienModule { }
