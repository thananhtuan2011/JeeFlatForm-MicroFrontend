...
import { DanhMucPhongBanListComponent } from "./danh-muc-phong-ban-list/danh-muc-phong-ban-list.component";
...
const routes: Routes = [
  {
    ...
    children: [
      {
        path: '',
        component: DanhMucPhongBanListComponent,
      },
    ]
  }
];
...
@NgModule({
  declarations: [
    ...
    DanhMucPhongBanListComponent,
    DanhMucPhongBanEditDialogComponent,
  ],
  imports: [
  ...
  providers: [
    ...
    DanhMucPhongBanService,
    HttpUtilsService,
    LayoutUtilsService,
    TranslationService,
  ],
})
export class DanhMucPhongBanModule { }
