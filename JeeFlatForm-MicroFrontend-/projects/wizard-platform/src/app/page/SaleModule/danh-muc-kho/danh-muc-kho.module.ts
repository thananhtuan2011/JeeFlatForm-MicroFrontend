...
import { DanhMucKhoListComponent } from "./danh-muc-kho-list/danh-muc-kho-list.component";
...
const routes: Routes = [
  {
    path: '',
    component: DanhMucKhoComponent,
    children: [
      {
        path: '',
        component: DanhMucKhoListComponent,
      },
    ]
  }
];
...
@NgModule({
  declarations: [
    DanhMucKhoComponent,
    DanhMucKhoListComponent,
    DanhMucKhoEditDialogComponent,
  ],
  imports: [
