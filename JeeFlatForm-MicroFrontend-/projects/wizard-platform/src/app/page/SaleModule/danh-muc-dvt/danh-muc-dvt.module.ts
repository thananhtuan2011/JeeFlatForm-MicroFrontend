...
import { DanhMucDVTListComponent } from "./danh-muc-dvt-list/danh-muc-dvt-list.component";
...
import { DanhMucDVTComponent } from "./danh-muc-dvt.component";
...
const routes: Routes = [
  {
    path: '',
    component: DanhMucDVTComponent,
    children: [
      {
        path: '',
        component: DanhMucDVTListComponent,
      },
    ]
  }
];
...
@NgModule({
  declarations: [
    DanhMucDVTComponent,
    DanhMucDVTListComponent,
    DanhMucDVTEditDialogComponent,
  ],
  imports: [
