...
import { DanhMucChiNhanhListComponent } from "./danh-muc-chi-nhanh-list/danh-muc-chi-nhanh-list.component";
...
import { DanhMucChiNhanhComponent } from "./danh-muc-chi-nhanh.component";
...
const routes: Routes = [
  {
    path: '',
    component: DanhMucChiNhanhComponent,
    children: [
      {
        path: '',
        component: DanhMucChiNhanhListComponent,
      },
    ]
  }
];
...
@NgModule({
  declarations: [
    DanhMucChiNhanhComponent,
    DanhMucChiNhanhListComponent,
    DanhMucChiNhanhEditDialogComponent,
  ],
  imports: [
...
export class DanhMucChiNhanhModule { }
