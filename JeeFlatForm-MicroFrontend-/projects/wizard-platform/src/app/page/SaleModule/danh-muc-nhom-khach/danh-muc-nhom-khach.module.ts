...
import { DanhMucNhomKhachListComponent } from "./danh-muc-nhom-khach-list/danh-muc-nhom-khach-list.component";
...
import { DanhMucNhomKhachComponent } from "./danh-muc-nhom-khach.component";
...
const routes: Routes = [
  {
    path: '',
    component: DanhMucNhomKhachComponent,
    children: [
      {
        path: '',
        component: DanhMucNhomKhachListComponent,
      },
    ]
  }
];
...
@NgModule({
  declarations: [
    DanhMucNhomKhachComponent,
    DanhMucNhomKhachListComponent,
    DanhMucNhomKhachEditDialogComponent,
  ],
  imports: [
...
export class DanhMucNhomKhachModule { }
