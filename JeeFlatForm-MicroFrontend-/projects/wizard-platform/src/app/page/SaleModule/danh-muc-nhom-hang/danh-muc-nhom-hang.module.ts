...
import { DanhMucNhomHangListComponent } from "./danh-muc-nhom-hang-list/danh-muc-nhom-hang-list.component";
...
import { DanhMucNhomHangComponent } from "./danh-muc-nhom-hang.component";
...
const routes: Routes = [
  {
    path: '',
    component: DanhMucNhomHangComponent,
    children: [
      {
        path: '',
        component: DanhMucNhomHangListComponent,
      },
    ]
  }
];
...
@NgModule({
  declarations: [
    DanhMucNhomHangComponent,
    DanhMucNhomHangListComponent,
    DanhMucNhomHangEditDialogComponent,
  ],
  imports: [
...
export class DanhMucNhomHangModule { }
