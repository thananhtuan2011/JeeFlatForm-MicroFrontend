...
import { DanhMucHangListComponent } from "./danh-muc-hang-list/danh-muc-hang-list.component";
...
import { DanhMucHangComponent } from "./danh-muc-hang.component";
...
const routes: Routes = [
  {
    path: '',
    component: DanhMucHangComponent,
    children: [
      {
        path: '',
        component: DanhMucHangListComponent,
      },
    ]
  }
];
...
@NgModule({
  declarations: [
    ...
    DanhMucHangListComponent,
    DanhMucHangEditDialogComponent,
  ],
  imports: [
...
export class DanhMucHangModule { }
