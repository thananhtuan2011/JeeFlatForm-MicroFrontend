...
import { DanhMucNCCListComponent } from "./danh-muc-ncc-list/danh-muc-ncc-list.component";
...
import { DanhMucNCCComponent } from "./danh-muc-ncc.component";
...
const routes: Routes = [
  {
    path: '',
    component: DanhMucNCCComponent,
    children: [
      {
        path: '',
        component: DanhMucNCCListComponent,
      },
    ]
  }
];
...
@NgModule({
  declarations: [
    DanhMucNCCComponent,
    DanhMucNCCListComponent,
    DanhMucNCCEditDialogComponent,
  ],
  imports: [
