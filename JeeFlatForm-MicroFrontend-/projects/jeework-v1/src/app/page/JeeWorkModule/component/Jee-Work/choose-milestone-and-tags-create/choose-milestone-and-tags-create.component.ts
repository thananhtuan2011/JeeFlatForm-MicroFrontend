...
import { MilestoneModel, TagsModel, UpdateWorkModel } from '../jee-work.model';
import { TagsService, WeWorkService } from '../jee-work.servide';
...
@Component({
	selector: 'kt-choose-milestone-and-tags-create',
	templateUrl: './choose-milestone-and-tags-create.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	encapsulation: ViewEncapsulation.None
})

export class ChooseMilestoneAndTagCreateComponent implements OnInit, OnChanges {
	// Public properties
	@Input() options: any[] = [];
