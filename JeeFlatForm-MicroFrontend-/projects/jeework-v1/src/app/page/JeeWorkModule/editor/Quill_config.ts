        ...
        upload: (file) => {
            return new Promise((resolve, reject) => {
                ...
                if (file.type === 'image/jpeg' || file.type === 'image/png' || file.type === 'image/jpg') { // File types supported for image
                    ...
                    let url = environment.HOST_JEEWORK_API + '/api/attachment/upload-img';
...
const editorStylesNew = {
    'border': '1px solid #ebedf2',
    'height': '400px',
    'font-size': '12pt'
};

const placeholderNew = "Nhập nội dung..."
export { quillConfigNew, editorStylesNew, placeholderNew, formatsNew, quillConfigv2New };
