...
const API_DatPhong = environment.APIROOT;
const API_general = environment.APIROOT + "/api/General";
const API_Meeting = environment.APIROOT + "/api/Meeting";
const API_Work = environment.HOST_JEEWORK_API + "/api";
const API_Meeting_Zoom = environment.APIROOT + "/api/key-zoom";
const API_Meeting_Google = environment.APIROOT + "/api/key-google";
const API_Meeting_Webex = environment.APIROOT + "/api/key-webex";
const API_Meeting_Teams = environment.APIROOT + "/api/key-ms";
const API_PRODUCTS_URL = environment.APIROOT + '/api/Meeting';
...
export class DangKyCuocHopService extends ITableService<any> {
	...
	data_share_type3 = new BehaviorSubject<any>([]);
	data_shareLoadChiTiet$ = new BehaviorSubject<any>([]);
