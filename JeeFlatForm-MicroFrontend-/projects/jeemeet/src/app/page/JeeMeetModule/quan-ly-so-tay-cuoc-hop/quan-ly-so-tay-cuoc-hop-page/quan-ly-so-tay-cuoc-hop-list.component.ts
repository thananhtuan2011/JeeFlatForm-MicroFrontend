...
import { QLCuocHopModel, QuanLySoTayGhiChuCuocHopModel } from '../../_models/quan-ly-cuoc-hop.model';
...
@Component({
	selector: 'app-quan-ly-so-tay-cuoc-hop-page',
	templateUrl: './quan-ly-so-tay-cuoc-hop-list.component.html',
	styleUrls: ['./quan-ly-so-tay-cuoc-hop-list.component.scss']
})


export class QuanLySoTayCuocHopPageComponent implements OnInit {
	...
	filterConfiguration(): any {
		...
		if (this.idMeeting) {
			filter["IdCuocHop"] = this.idMeeting;
		}
