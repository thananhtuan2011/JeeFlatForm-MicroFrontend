...
@Component({
	selector: "kt-thong-ke-cuoc-hop-view-edit.component",
	templateUrl: "./thong-ke-cuoc-hop2-edit.component.html",
	changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ThongKeCuocHopViewFileEditComponent implements OnInit {
	 ...
	 */
	constructor(
		public dialogRef: MatDialogRef<ThongKeCuocHopViewFileEditComponent>,
