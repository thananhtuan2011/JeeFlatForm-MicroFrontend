...
export class SurveyPhieuKhaoSatListComponent implements OnInit {
  ...
  isCopy: boolean = false;
	...
	constructor(
		public dialogRef: MatDialogRef<SurveyPhieuKhaoSatListComponent>,
