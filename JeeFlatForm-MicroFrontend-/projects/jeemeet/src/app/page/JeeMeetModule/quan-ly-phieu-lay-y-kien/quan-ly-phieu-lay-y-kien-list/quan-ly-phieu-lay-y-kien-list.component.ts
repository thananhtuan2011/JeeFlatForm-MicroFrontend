...
export class QuanLyPhieuLayYKienListComponent implements OnInit {
	...
	Title(item) {
		if (item.TrangThai == 0) {
			...
			return this.translate.instant('MENU_PHIEULAYYKIEN.QUAHAN')
		}
	}
