...
import { NgbDatepickerModule, NgbModalModule, NgbDropdownModule, NgbModule } from '@ng-bootstrap/ng-bootstrap';
...
import { PhieuLuongComponent } from './phieu-luong.component';
import { RouterModule, Routes } from '@angular/router';
import { PhieuLuongListComponent, SafeHtmlPipe } from './phieu-luong-list/phieu-luong-list.component';
...
@NgModule({
  ...
  providers: [
    ...
    XemPhieuLuongService,
    BangCongService,
    HttpUtilsService,
  ],
})
export class PhieuLuongModule {}
