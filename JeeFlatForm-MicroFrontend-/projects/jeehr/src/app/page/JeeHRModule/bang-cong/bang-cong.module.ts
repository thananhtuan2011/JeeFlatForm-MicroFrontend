...
import { BangCongListComponent } from "./bang-cong-list/bang-cong-list.component";
import { BangCongComponent } from "./bang-cong.component";
...
const routes: Routes = [
  {
    ...
    children: [
      {
        path: '',
        component: BangCongListComponent,
      },
    ]
  }
];
