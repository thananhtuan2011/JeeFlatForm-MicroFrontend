...
import { SoDoToChucComponent } from './so-do-to-chuc.component';
import { RouterModule, Routes } from '@angular/router';
import { SoDoToChucListComponent } from './so-do-to-chuc-list/so-do-to-chuc-list.component';
