...
import { TopicService } from '../../../jee-team/jeeteam/services/topic.service';
@Component({
...
export class JeeCommentPostContentComponent implements OnInit, OnDestroy {
  ...
  UpdateSlCommentTopic(idtopic: number) {
    this.topic_service.RemoveCountComment(idtopic).subscribe()
  }
  ngOnInit() {

    console.log("IdTopic post", this.IdTopic)
          ...
          if (this.replyCommentID) {
            ...
            this.service
              ...
              .pipe(
                ...
                finalize(() => { this.UpdateSlCommentTopic(this.IdTopic) }),
                takeUntil(this.onDestroy),
                share()
              )
              .subscribe();
