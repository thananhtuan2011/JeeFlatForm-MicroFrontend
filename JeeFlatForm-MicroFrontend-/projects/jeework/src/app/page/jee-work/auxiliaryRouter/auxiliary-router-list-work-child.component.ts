...
@Component({
    selector: 'app-auxiliary-router-list-work-child',
    templateUrl: './auxiliary-router.component.html',
})
export class AuxiliaryRouterListWorkGOVChildComponent implements OnInit {
    ...
    close() {
        ...
        AuxiliaryRouterListWorkGOVChildComponent.dialogRef = null;
    }
    ...
    openDialog(id) {
        ...
        AuxiliaryRouterListWorkGOVChildComponent.dialogRef = this.dialog.open(ListNhiemVuPopupV2ChildComponent, dialogConfig);
        AuxiliaryRouterListWorkGOVChildComponent.dialogRef.afterClosed().subscribe(result => {
            this.close();
            AuxiliaryRouterListWorkGOVChildComponent.dialogRef = null;
        });
    }
