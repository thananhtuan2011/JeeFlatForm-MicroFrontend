...
import { BaoCaoNhiemVuDaXoaModel } from "../Model/jee-work.model"

@Component({
  selector: "app-bao-cao-nhiem-vu-da-xoa",
  templateUrl: "./bao-cao-nhiem-vu-da-xoa.component.html",
  styleUrls: ["./bao-cao-nhiem-vu-da-xoa.component.scss"],
})
export class BaoCaoNhiemVuDaXoaComponent implements OnInit {
  listData: any[] = [];
  dataLazyLoad: any = [];
  ...
  getdata() {
    ...
    this.BaoCaoService.getListTaskDeleteReport(queryParams).subscribe((res) => {
  ...
  ExportExcel() {
    const list = new Array<BaoCaoNhiemVuDaXoaModel>();
    this.listData.forEach(i => {
      const item = new BaoCaoNhiemVuDaXoaModel(
        i.id_row,
        i.so_hieu_vb,
        i.ngay_vb,
        i.trich_yeu_vb,
    ...
    this.BaoCaoService.ExportExcelTaskDeleteReport(queryParams,list).subscribe((response) => {
