...
import { BaoCaoCongViecModel } from "../Model/jee-work.model"

@Component({
  selector: "app-bao-cao-cong-viec",
  templateUrl: "./bao-cao-cong-viec.component.html",
  styleUrls: ["./bao-cao-cong-viec.component.scss"],
})
export class BaoCaoCongViecComponent implements OnInit {
  ...
  filterConfiguration(): any {
    ...
    this.filter.id_follower = this.id_follower;
  ...
  ExportExcel() {
    const list = new Array<BaoCaoCongViecModel>();
    this.listData.forEach(i => {
      const item = new BaoCaoCongViecModel(
        i.id_row,
        i.so_hieu_vb,
    ...
    this.BaoCaoService.ExportExcelTaskTheoDoiNhiemVu(queryParams,list).subscribe((res) => {
