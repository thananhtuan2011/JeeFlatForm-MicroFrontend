...
import { WorkViewModel } from '../Model/jee-work.model';
...
const API_PROJECT = environment.HOST_JEEWORK_API_2023 + '/api/project';
const API_STATUS = environment.HOST_JEEWORK_API_2023 + '/api/group-status';
...
export class ProjectsTeamService {
    ...
    Project_Detail(id: any): Observable<any> {
        const httpHeaders = this.httpUtils.getHTTPHeaders();
        const url = `${API_PROJECT}/Detail?id=${id}`;
        return this.http.get<any>(url, { headers: httpHeaders });
    }
    ...
    ListGroupStatus(queryParams: QueryParamsModelNew): Observable<QueryResultsModel> {
        const httpHeaders = this.httpUtils.getHTTPHeaders();
        const httpParams = this.httpUtils.getFindHTTPParams(queryParams);
        const url = API_STATUS + '/list-group-status';
        return this.http.get<QueryResultsModel>(url, {
            headers: httpHeaders,
            params: httpParams
        });
...
const API_TP_Lite = environment.HOST_JEEWORK_API_2023 + '/api/general';
...
const API_work_groupV2 = environment.HOST_JEEWORK_API_2023 + '/api/work-group';
...
export class WorkService {
    ...
    list_tag(id_project_team: number): Observable<any> {
        const httpHeaders = this.httpUtils.getHTTPHeaders();
        return this.http.get<any>(environment.HOST_JEEWORK_API_2023 + `/api/general/lite_tag?id_project_team=${id_project_team}`, { headers: httpHeaders });
    }
    ...
    ListWorkGroupV2(queryParams: QueryParamsModelNew): Observable<any> {
        const httpParams = this.httpUtils.getFindHTTPParams(queryParams);
        const httpHeaders = this.httpUtils.getHTTPHeaders();
        return this.http.get<any>(API_work_groupV2 + '/list', {
            headers: httpHeaders,
            params: httpParams
        });
    }
    ...
    UpdateWorkGroupV2(item): Observable<any> {
        const httpHeaders = this.httpUtils.getHTTPHeaders();
        return this.http.post<any>(API_work_groupV2 + '/update-workgroup', item, { headers: httpHeaders });
    }
    ...
    CloseWorkGroupV2(id: number, closed: number): Observable<any> {
        const httpHeaders = this.httpUtils.getHTTPHeaders();
        const url = `${API_work_groupV2}/Close?id=${id}&&closed=${closed}`;
        return this.http.get<any>(url, { headers: httpHeaders });
    }
