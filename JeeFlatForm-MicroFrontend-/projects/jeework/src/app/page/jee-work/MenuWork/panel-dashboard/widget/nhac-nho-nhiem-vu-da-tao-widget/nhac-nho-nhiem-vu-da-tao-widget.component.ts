...
@Component({
  selector: 'nhac-nho-nhiem-vu-da-tao-widget',
  templateUrl: './nhac-nho-nhiem-vu-da-tao-widget.component.html',
  styleUrls: ['./nhac-nho-nhiem-vu-da-tao-widget.component.scss'],
})
export class NhacNhoNhiemVuDaTaoWidgetComponent
  implements
  OnInit {
    text: any;
    projectname: any;
