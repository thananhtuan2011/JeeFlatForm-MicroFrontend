...
// import { BieuDoTheoDoiService } from "../../Services/bieu-do-theo-doi-tinh-hinh-thuc-hien-nhiem-vu.service";
// import { LandingPageService } from "../../Services/landing-page.service";

@Component({
  selector: "bieu-do-theo-doi-tinh-hinh-thuc-hien-nhiem-vu",
  templateUrl: "./bieu-do-theo-doi-tinh-hinh-thuc-hien-nhiem-vu.component.html",
})
export class BieuDoTheoDoiTinhHinhThucHienNhiemVuComponent
  implements
  OnInit,
  OnDestroy,
  ICreateAction,
  ...
  pieChart(query) {
    this._BieuDoTheoDoiService.fetch_Report_Bieudotheodoi("", query);
