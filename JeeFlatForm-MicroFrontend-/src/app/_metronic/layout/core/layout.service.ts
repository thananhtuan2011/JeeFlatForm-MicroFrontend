...
import { DefaultLayoutConfigDark } from './default-layout.config.dark';
...
export class LayoutService {
  ...
  initConfig(): void {
    ...
    if (localStorage.getItem('user-theme')) {
      if (localStorage.getItem('user-theme') == 'light-mode') {
        this.layoutConfigSubject.next(DefaultLayoutConfig);
      } else {
        this.layoutConfigSubject.next(DefaultLayoutConfigDark);
      }
    } else {
      this.layoutConfigSubject.next(DefaultLayoutConfig);
    }
